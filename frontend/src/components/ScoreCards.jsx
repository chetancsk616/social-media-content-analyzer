...
const SCORE_CONFIGS = [
  {
    ...
    label: 'Hook Strength',
    icon: '🪝',
    description: 'Quality of the opening line',
    color: { bar: 'from-violet-600 to-violet-400', text: 'text-violet-400', bg: 'bg-violet-500/10', border: 'border-violet-500/20' },
  },
  {
    key: 'cta',
    label: 'CTA Strength',
    ...
    color: { bar: 'from-accent-600 to-accent-400', text: 'text-accent-400', bg: 'bg-accent-500/10', border: 'border-accent-500/20' },
  },
  {
    key: 'clarity',
    ...
    color: { bar: 'from-sky-600 to-sky-400', text: 'text-sky-400', bg: 'bg-sky-500/10', border: 'border-sky-500/20' },
  },
  {
    key: 'readability',
    label: 'Readability',
    ...
    color: { bar: 'from-emerald-600 to-emerald-400', text: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20' },
  },
  {
    key: 'structure',
    label: 'Structure',
    icon: '🏗️',
    description: 'Content organisation',
    color: { bar: 'from-amber-600 to-amber-400', text: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/20' },
  },
]
